     ...
     <div class="w-full flex items-center justify-center mt-2">
        <footer class="p-4 w-full bg-white sm:p-6 dark:bg-gray-800">
          <div class="md:flex md:justify-center">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-20 sm:grid-cols-3">
              <div>
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>
                    <a href="#" target="_blank" class="text-gray-600 hover:underline dark:text-gray-400">Terms of use</a>
                  </li>
                </ul>
              </div>
              <div>
